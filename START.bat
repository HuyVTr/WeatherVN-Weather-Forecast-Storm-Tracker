...
if "%_err%"=="6" goto END_SCRIPT
if "%_err%"=="5" goto RUN_RAI_SIMULATION_AND_SERVER
if "%_err%"=="4" goto RUN_FULL_TRAIN
if "%_err%"=="3" goto RUN_QUICK_TRAIN
if "%_err%"=="2" goto RUN_ONE_TIME_REALTIME_AND_SERVER
if "%_err%"=="1" goto START_CONTINUOUS_FORECAST_AND_SERVER
